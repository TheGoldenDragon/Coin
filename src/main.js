...
const initHttpServer = (myHttpPort) => {
    ...
    app.get('/transactionPool', (req, res) => { res.send(transactionPool_1.getTransactionPool()); });
    app.get('/sockets', (req, res) => { res.send(p2p_1.getSockets().map((s) => s._socket.remoteAddress + ':' + s._socket.remotePort)); });
    app.get('/peers', (req, res) => { res.send(p2p_1.getPeers()); });
    app.post('/addPeer', (req, res) => { p2p_1.connectToPeer(req.body.peer); res.send(); });
